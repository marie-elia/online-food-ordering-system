...
?>     
				...
				<h4 class="price" name="price"><?php echo ($price) ?> L.E</h4>
									</div>			
									<p name="description">
										<?php   
                                                                                echo($description);                       
...
//echo date('g:i A', strtotime($menuto));
  ...
  {  function runMyFunction() {
    ...
    $one="true";// $ins_query="insert into addtocart (`item_name`,`price`,`description`)values('$item_name','$price','$description')";
                   //echo $one;
  }
...
?>
                                                    <a href='privilege.php' type="submit" > add </a>
...
//echo $twos;
             ...
             ?>       
				...
				<h4 class="price"><?php echo ($pri) ?> L.E</h4>
									</div>			
									<p>
										<?php echo($descrip)?>
									</p>	
                                                                         <p>From:<?php echo($menufrom);?></p>
                                    <p> To:<?php echo($menuto);?></p>
                                                    <a href='item2.php' type="submit" > add </a>
...
$_SESSION['descrip3'] = $des;
             ...
             ?>       
				...
				<h4 class="price"><?php echo ($pr) ?> L.E</h4>
									</div>			
									<p>
										<?php echo($des)?>
									</p>	
                                                                         <p>From:<?php echo($menufrom);?></p>
                                    <p> To:<?php echo($menuto);?></p>
                            <form action="addtocart.php" method="post" ><a href="addtocart.php"></a>
                                                <a href='item3.php' type="submit" > add </a>
  ...
  $menufrom=$row['menufrom'];
             ...
             $counter_int++;
            $_SESSION['item4'] =  $item_name4;
$_SESSION['price4'] = $price4;
$_SESSION['descrip4'] =$description4;     
            }  
             ...
             ?>       
				...
				<h4 class="price"><?php echo ($price4) ?> L.E</h4>
									</div>			
									<p name="description">
										<?php echo($description4)?>
                                                                         ...
                                                                         <p>From:<?php echo($menufrom);?></p>
                                    <p> To:<?php echo($menuto);?></p>
                                                                                <a href='item4.php' type="submit" > add </a>
  ...
  while ($row = $result->fetch_assoc()) 
            {
        unset( $itemId ,$description7 ,$price7 ,$item_name7);       
                  $itemId= $row['itemId'];
                  $description7 = $row['description'];
                  $item_name7=$row['item_name'];
                   $price7= $row['price'];
 $menufrom=$row['menufrom'];
                   $menuto=$row['menuto'];
                     echo($item_name7) ;
             ...
             $counter_int++;
        $_SESSION['item7'] =  $item_name7;
$_SESSION['price7'] = $price7;
$_SESSION['descrip7'] =$description7;                 
            }  
            ...
            <h4 class="price" ><?php echo ($price7) ?> L.E</h4>
									</div>			
									<p>
										<?php echo($description7)?>
                                                                         ...
                                                                         <p>From:<?php echo($menufrom);?></p>
                                    <p> To:<?php echo($menuto);?></p>
                                                                                                  <a href='item7.php' type="submit" > add </a>
  ...
  while ($row = $result->fetch_assoc()) 
            {
        unset( $itemId ,$description5 ,$price5 ,$item_name5);       
                  $itemId= $row['itemId'];
                  $description5 = $row['description'];
                  $item_name5=$row['item_name'];
                   $price5= $row['price'];
 $menufrom=$row['menufrom'];
                   $menuto=$row['menuto'];
                     echo($item_name5) ;
             ...
             $counter_int++;
                $_SESSION['item5'] =  $item_name5;
$_SESSION['price5'] = $price5;
$_SESSION['descrip5'] =$description5;       
            }  
             ...
             ?>       
				...
				<h4 class="price"><?php echo ($price5) ?> L.E</h4>
									</div>			
									<p>
										<?php echo($description5)?>
									</p>			
                            <form action="addtocart.php" method="post" ><a href="addtocart.php"></a>
                                                        <a href='item5.php' type="submit" > add </a>
  ...
  while ($row = $result->fetch_assoc()) 
            {
        unset( $itemId ,$description6 ,$price6 ,$item_name6);       
                  $itemId= $row['itemId'];
                  $description6 = $row['description'];
                  $item_name6=$row['item_name'];
                   $price6= $row['price'];
$menufrom=$row['menufrom'];
                   $menuto=$row['menuto'];
                     echo($item_name6) ;
                   // echo($itemId) ;
                 echo "<div><p>Item ID: $itemId </p></div>";                      
  $_SESSION['item6'] =  $item_name6;
$_SESSION['price6'] = $price6;
$_SESSION['descrip6'] =$description6;   
                 // echo "<p> $description </p>";                      
             ...
             ?>       
				...
				<h4 class="price"><?php echo ($price6) ?> L.E</h4>
									</div>			
									<p>
                            ...
                            <form action="addtocart.php" method="post" ><a href="addtocart.php"></a>
                                                        ...
                                                        <a href='item6.php' type="submit" > add </a>
