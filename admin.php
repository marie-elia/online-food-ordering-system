				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-between">
                                            ...
                                            <div class="col-lg-12 banner-content">
                                                ...
                                                <div>
                                                         <li ><a href='addadmin.php'class="text-white"></a></li>
                                                <li ><a href='addadmin.php'class="text-white"></a></li>
                                                <li ><a href='addadmin.php'class="text-white"></a></li>

                                                <li ><a href='addadmin.php'class="text-white">Add admin</a></li>
                                                                                              <li ><a href='adminpasscontroller.php' class="text-white">Change other Admin Pasword</a>   </li>
                                                <li ><a href='deleteadmin.php' class="text-white">Delete Admin</a>   </li>
                                                                                                <li><a href='addstaff.php'class="text-white">Add Staff</a></li>

                                              <li ><a href='staffpasscontroller.php' class="text-white">Change other Staff Password</a>   </li>
                                                <li ><a href='deletestaff.php' class="text-white">Delete Staff</a>   </li>

                                              <li ><a href='reset-password.php' class="text-white">Reset Password</a>   </li>
                                              <li ><a href='viewrestaurant.php' class="text-white">Edit and Delete Restaurants</a></li>
                                            <li ><a href='addrestaurant.php' class="text-white">Add Restaurant</a>   </li>

                                                 <li ><a href='resinfocontroller.php' class="text-white">Edit and Delete Restaurant Info</a></li>
                                                 <li ><a href='insertresinfo.php' class="text-white">Add Restaurant Info</a></li>
                                                 <li ><a href='insertmenu.php' class="text-white">Add Different Menus in a Restaurant</a></li>
                                                 <li ><a href='menucontroller.php' class="text-white">Edit and Delete Different Menus in a Restaurant</a></li>
                                                 <li ><a href='itemcontroller.php' class="text-white">Edit and Delete Restaurant Items</a></li>
                                                <li ><a href='additem.php' class="text-white">Add Restaurant Item</a></li>
                                                 <li ><a href='itemcustcontroller.php' class="text-white">Edit and Delete Different Menu Configurations in a Restaurant</a></li>
                                                
                                                 <li ><a href='insertpromores.php' class="text-white">Insert Restaurants PromoCodes</a></li>
                                                 <li ><a href='promoresdelete.php' class="text-white">Update and Delete  Restaurants PromoCodes</a></li>

                                                 <li ><a href='discdel.php' class="text-white">Edit and Delete  User PromoCode</a></li>
                                                 <li ><a href='insertPromo.php' class="text-white">Insert New User PromoCode</a></li>

                                                 <li ><a href='view.php' class="text-white">Edit and Delete Users</a>   </li>
