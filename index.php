				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          <li><a href="index.php">Home</a></li>
                                          <li><a href="MenuTime.php">Menu Time</a></li>
...
$username = $_SESSION['var3'];}
//$username = $_GET['var3'];   
 //print_r($_SESSION);
      //           $var_value = $_REQUEST['var1'];
             //    echo $var_value;
$user= $_SESSION['username'];
?>  <li><a href="profile.php?username=<?php echo $user;?>">Profile</a></li>
                                              <li><a href="address.php?username=<?php echo $user;?>">Address</a></li>
                                    <li><a href="history.php?username=<?php echo $user;?>">Food History</a></li>


                                          <li><a href="profile.php?username=<?php echo $user;?>">Profile</a></li>
                                                                                          <li><a href="track.php?username=<?php echo$user;?>">Track Order</a></li>
