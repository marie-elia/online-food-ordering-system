    ...
    <div class="wrapper">
        ...
        <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="wrap-input100 validate-input"  <?php echo (!empty($username_err)) ? 'has-error' : ''; ?> >
                <label> Please Enter the new Admin's Username</label>
                <input type="text" name="username" class="form-control"  value="<?php echo $username; ?>">
                <span class="help-block"><?php echo $username_err; ?></span>
            </div>    
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                <label>Please Enter the new Admin's Password</label>
                <input type="password" name="password" class="form-control" value="<?php echo $password; ?>">
                <span class="help-block"><?php echo $password_err; ?></span>
            </div>
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                <label>Please Confirm the new Admin's Password</label>
            ...
            <div class="form-group <?php echo (!empty($FName_err)) ? 'has-error' : ''; ?>">
                <label>Enter the new Admin's First Name</label>
                <input type="text" name="fname" class="form-control" value="<?php echo $FName; ?>">
                <span class="help-block"><?php echo $FName_err; ?></span>
            </div>
            <div class="form-group <?php echo (!empty($LName_err)) ? 'has-error' : ''; ?>">
                <label>Enter the new Admin's Last Name</label>
                <input type="text" name="lname" class="form-control" value="<?php echo $LName; ?>">
                <span class="help-block"><?php echo $LName_err; ?></span>
            </div>
            <div class="form-group <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
                <label>Enter the new Admin's Email </label>
                <input type="email" name="email" class="form-control" value="<?php echo $email; ?>">
                <span class="help-block"><?php echo $email_err; ?></span>
            </div>
            <div class="form-group <?php echo (!empty($mnumber_err)) ? 'has-error' : ''; ?>">
                <label>Enter the new Admin's Mobile Number</label>
            ...
            <div class="form-group <?php echo (!empty($age_err)) ? 'has-error' : ''; ?>">
                <label>Enter the new Admin's age</label>
