...
<form method="POST" action="radio_value.php">
                <p>Size :</p>
    <input type="radio" name="MyRadio" value="First" checked>Medium<br/> 
    <input type="radio" name="MyRadio" value="Second">Large<br/>
    <?php 
    $itemId=1;    ?>
    
    
    <input class="btn btn-primary" type="submit" value="Select this size" name="Result"> 
</form>
...
$quantity="";
$quantity_err="";  
echo (!empty($quantity_err)) ? 'has-error' : ''; ?>">
...
<form name="form" method="post" action="submitform.php">
 <input type="number" name="quantity" id="quantity" class="form-control" value="<?php echo $quantity; ?>">
     <input class="btn btn-primary" type="submit" value="select this quantity" name="submit"> 
<?php
